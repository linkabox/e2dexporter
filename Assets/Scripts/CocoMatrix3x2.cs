...
public struct CocoMatrix3x2
{
	...
	private static readonly CocoMatrix3x2 identityMatrix = new CocoMatrix3x2(1024, 0, 0, 1024, 0, 0);
	public static CocoMatrix3x2 identity
	{
		get
		{
			return CocoMatrix3x2.identityMatrix;
		}
	}

	public CocoMatrix3x2(int m00, int m01, int m10, int m11, int m20, int m21)
	{
		this.m00 = m00;
		this.m01 = m01;
		this.m10 = m10;
	...
	public CocoMatrix3x2(Matrix4x4 mat4x4)
	{
	...
	public static CocoMatrix3x2 FromE2DImage(E2DUIComponent com, E2DSprite e2DSprite)
	{
	...
	public static CocoMatrix3x2 FromUICom(E2DUIComponent com)
	{
		return FromTRS(com.e2dPos, com.e2dRot, com.e2dScale);
	}

	public static CocoMatrix3x2 FromText(E2DUIComponent com)
	{
	...
	public static CocoMatrix3x2 FromClip(E2DUIComponent com)
	{
		var fixPos = new Vector3(-com.node.sizeDelta.x * com.e2dScale.x / 2, com.node.sizeDelta.y * com.e2dScale.y / 2, 0);
		return FromTRS(com.e2dPos + fixPos, com.e2dRot, com.e2dScale);
	}

	public static CocoMatrix3x2 FromTRS(Vector3 pos, Quaternion rot, Vector3 scale)
	{
		...
		return new CocoMatrix3x2(finalMat);
	}
