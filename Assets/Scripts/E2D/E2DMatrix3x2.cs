...
public struct E2DMatrix3x2
{
	...
	{
		var mat4x4 = Matrix4x4.TRS(com.node.localPosition, com.node.localRotation, com.node.localScale);
	...
	{
		var mat4x4 = Matrix4x4.TRS(com.node.localPosition + offset, com.node.localRotation, com.node.localScale);
		return new E2DMatrix3x2(mat4x4);
	}
